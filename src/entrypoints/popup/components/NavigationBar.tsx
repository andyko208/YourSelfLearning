...
const Icon: React.FC<{ id: string; selected: boolean }> = ({ id, selected }) => {
    ...
    // friends: now represents Todos – checklist icon with outline/filled
    if (id === 'friends') {
      if (selected) {
        // Filled variant: clipboard with checkmarks
        return (
          <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="currentColor">
            <path d="M9 2h6a2 2 0 0 1 2 2h1a2 2 0 0 1 2 2v12a3 3 0 0 1-3 3H7a3 3 0 0 1-3-3V6a2 2 0 0 1 2-2h1a2 2 0 0 1 2-2Zm0 2v1h6V4H9Z"></path>
            <path d="M9 10h6v2H9z"></path>
            <path d="M8 14h4v2H8z"></path>
            <path d="M8.5 9.5 7 11l1.5 1.5L12 9l-1.5-1.5z"></path>
          </svg>
        );
      }
      // Outline variant: clipboard with checks
      return (
        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
          <rect x="4" y="5" width="16" height="15" rx="2" ry="2"></rect>
          <path d="M9 3h6a2 2 0 0 1 2 2H7a2 2 0 0 1 2-2z"></path>
          <path d="M9 10h6"></path>
          <path d="M8 14h4"></path>
          <path d="m7.5 11.5 1.5 1.5L12 10"></path>
        </svg>
      );
    }
...
export const NavigationBar: React.FC<NavigationBarProps> = ({ currentPage, onNavigate }) => {
  const handleNavClick = (
    ...
    onNavigate(id as 'home' | 'settings' | 'library' | 'friends');
  };
